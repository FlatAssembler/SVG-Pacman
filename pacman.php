	...
	<script type="text/javascript">
        if (
          ...
          window.onresize = function () {
            ...
            if (startButton) startButton.style.left = sredinaEkrana - 100 + "px";
      ...
      function drawGhosts() {
        ...
        function touchScreenInterface(event) {
          ...
          if (Math.abs(xKoordinataPacmana - x) > Math.abs(yKoordinataPacmana - y)) {
            if (x < xKoordinataPacmana) onButtonLeft();
            else onButtonRight();
          } else {
            if (y < yKoordinataPacmana) onButtonUp();
            else onButtonDown();
          }
        }
        function mainLoop() {
          ...
          for (var i = 0; i < 3; i++) {
            ...
            if (bijeli != null) zaslon.removeChild(bijeli);
          ...
          if (howManyDotsHasPacmanEaten == howManyDotsAreThere) nextLevel();
        }
        function animationLoop() {
          if (brojacGlavnePetlje < 2) return; //Ne pokusavaj animirati PacMana i duhove ako jos nisu nacrtani.
        ...
        function nestajanje() {
          ...
          } else document.body.removeChild(natpis);
        }
        function showLevel() {
          clearInterval(time1);
          clearInterval(time2);
